...
const casBaseUrl = "https://cas.univ-lyon1.fr/cas/login";
const serviceUrl = encodeURIComponent(window.location.origin + "/callback"); 
const url= `${casBaseUrl}?service=${serviceUrl}`;
...
<template>
  <div>
    ...
    <a href="https://cas.univ-lyon1.fr/cas/login?service=localhost:5173//callback">Login</a>
