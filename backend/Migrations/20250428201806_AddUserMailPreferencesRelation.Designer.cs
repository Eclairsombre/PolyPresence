...
namespace backend.Migrations
{
    ...
    [Migration("20250428201806_AddUserMailPreferencesRelation")]
    partial class AddUserMailPreferencesRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    b.HasOne("backend.Models.MailPreferences", "MailPreferences")
                        .WithOne()
                        .HasForeignKey("backend.Models.User", "MailPreferencesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
